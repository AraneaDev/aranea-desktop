...
requiresSignature(notificationsQml, 'function isTransient(notification): bool', 'notification isTransient')
requiresSignature(notificationsQml, 'function shouldStore(notification, snapshot): bool', 'notification shouldStore')
...
requiresSignature(inboxQml, 'function upsert(entry: var, onScreen: bool, deadline: real): void', 'inbox upsert')
requiresSignature(inboxQml, 'function setOnScreen(fileName: string, onScreen: bool): void', 'inbox setOnScreen')
