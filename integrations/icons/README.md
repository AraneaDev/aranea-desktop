...
(`integrations/icons/aranea/`) that overrides a compact file-manager core
(places, devices, status, actions, common MIME types, and essential apps) with
solid command-center-style glyphs, and inherits
